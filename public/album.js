const TRANSLATIONS = {
  ru: {
    ...
    hero_text:"Фотографии встреч, общения и всего того, что делает AWANA нашей семьёй.",
    ...
    album_1:"Вечер AWANA", album_2:"Осенняя встреча", album_3:"Зимняя встреча",
    ...
    cta_button:"Перейти на AWANA", footer:"Фотоальбом AWANA ♡"
  },
  ua: {
    lang_label:"UA", home:"На головну", albums_nav:"Альбоми",
    eyebrow:"НАШІ МОМЕНТИ ✦", hero_1:"Люди.", hero_2:"Життя.", hero_3:"Справжні моменти.",
    hero_text:"Фотографії зустрічей, спілкування і всього того, що робить AWANA нашою сім’єю.",
    ...
    album_1:"Вечір AWANA", album_2:"Осіння зустріч", album_3:"Зимова зустріч",
  ...
  fr: {
    ...
    hero_text:"Les photos de nos rencontres, de nos échanges et de tout ce qui fait d’AWANA une famille.",
    ...
    album_1:"Soirée AWANA", album_2:"Rencontre d’automne", album_3:"Rencontre d’hiver",
    ...
    cta_button:"Aller sur AWANA", footer:"Album photo AWANA ♡"
  }
};
